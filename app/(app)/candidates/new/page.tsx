...
export default function NewCandidatePage() {
  ...
  return (
    <Form
      ...
      headerDescription={
        <span>
          Загрузите файл резюме (PDF/DOCX/RTF/TXT), чтобы автоматически
          заполнить поля кандидата. Можно перетащить файл в область формы.
        </span>
      }
    ...
    >
      <FormBody>
        <FormField>
          <Label className="shrink-0 basis-3/12" htmlFor="jobId" required>
            Вакансия
          </Label>
          <FormSelect
            getOptions={getJobs}
